...
# pip install --upgrade py-dateutil pytz gTTS pydub ffmpeg
    ...
    if 'text' in message:
        ...
        # handle the /weather command
            ...
            if not parameters:  # no parameters provided
                mahue_bot.telegram_query("sendMessage", {'chat_id': message['chat']['id'],
                ...
                for location in locations.keys():
                    msg += "\n- `" + location + "`"
                mahue_bot.telegram_query("sendMessage",
